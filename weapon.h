...
/*
///Декораторы для итератора контейнера MegaWeaponContainer

class MegaWeaponTypeIteratorDecorator : public IteratorDecorator<WeaponPtr>
{
private:
    WeaponType targetType;

public:
    MegaWeaponTypeIteratorDecorator(Iterator<WeaponPtr> *it, WeaponType type)
...
class MegaWeaponCountryIteratorDecorator : public IteratorDecorator<WeaponPtr>
{
private:
    WeaponCountry targetCountry;

public:
    MegaWeaponCountryIteratorDecorator(Iterator<WeaponPtr> *it, WeaponCountry country)
        : IteratorDecorator(it), targetCountry(country) {}
...
class MegaWeaponCaliberIteratorDecorator : public IteratorDecorator<WeaponPtr>/
{
private:
    WeaponCaliber targetCaliber;

public:
    MegaWeaponCaliberIteratorDecorator(Iterator<WeaponPtr> *it, WeaponCaliber caliber)
        : IteratorDecorator(it), targetCaliber(caliber) {}
